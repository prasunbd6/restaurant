...
const Editcategory = () => {
  ...
  const category=()=>{
    axios
    .get(`https://restaurent1942.onrender.com/category/${id}`) // Here "category" is data table
    .then((response) => {
  ...
  const handleUpdate = (e) => {
    e.preventDefault();
    axios
      .put(`https://restaurent1942.onrender.com/category/${id}`, categoryTable) // Here "entry" is data table
      .then((response) => {
        // handle success
